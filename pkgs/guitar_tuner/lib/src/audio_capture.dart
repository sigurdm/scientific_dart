...
@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Float>, ffi.Int32)>()
external void tuner_get_samples(ffi.Pointer<ffi.Void> context, ffi.Pointer<ffi.Float> output, int count);
...
final class AudioCapture {
  ...
  void read(NDArray<double> buffer) {
    ...
    if (buffer.shape[0] < bufferSize) {
      throw ArgumentError('Buffer is too small (expected at least $bufferSize)');
    }
