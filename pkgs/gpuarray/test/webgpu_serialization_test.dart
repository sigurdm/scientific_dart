...
void main() {
  group('WebGPU Compute Pipeline Serialization & Browser Widgets', () {
    test('GpuComputePipelinePackage serializes to JSON and deserializes cleanly', () {
    ...
    test('toHtml() produces valid self-contained HTML with WebGPU client bootstrap script', () {
      final pkg = GpuComputePipelinePackage(
        name: 'fractal_shader',
    ...
    test('FusedKernelDescriptor creates interactive WebGPU browser widget', () {
      final dev = GpuDevice.cpu(name: 'Test Device');
      final x = GpuArray.fromList([1.0, 2.0, 3.0, 4.0], [4], DType.float32, device: dev);
