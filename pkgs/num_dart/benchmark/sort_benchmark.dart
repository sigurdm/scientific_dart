...
void main() {
  ...
  print('        num_dart TIMSORT & ARGSORT COMPREHENSIVE BENCHMARK SUITE            ');
  print('============================================================================\n');
...
void benchmarkType(String label, int size, Float64List template) {
  ...
  print('${label.padRight(16)} | Direct sort(): ${avgSortUs.toStringAsFixed(2).padLeft(10)} us | Argsort(): ${avgArgsortUs.toStringAsFixed(2).padLeft(10)} us');
  target.dispose();
}
