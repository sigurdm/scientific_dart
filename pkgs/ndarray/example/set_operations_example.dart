...
void main() {
  NDArray.scope(() {
    print('=== unique ===');
    final a = NDArray<AnyInt>.fromList([1, 2, 2, 3, 1, 4], [6], DType.int32);
    final u = unique(a);
    print('Input: ${a.toList()}');
    print('Unique: ${u.toList()}'); // [1, 2, 3, 4]

    print('\n=== intersect1d ===');
    final ar1 = NDArray<AnyInt>.fromList([1, 3, 4, 3], [4], DType.int32);
    final ar2 = NDArray<AnyInt>.fromList([3, 1, 2, 1], [4], DType.int32);
    ...
    print('\n=== setdiff1d ===');
    final sd1 = NDArray<AnyInt>.fromList([1, 2, 3, 2, 4], [5], DType.int32);
    final sd2 = NDArray<AnyInt>.fromList([2, 3, 5], [3], DType.int32);
    ...
    print('\n=== setxor1d ===');
    final sx1 = NDArray<AnyInt>.fromList([1, 2, 3], [3], DType.int32);
    final sx2 = NDArray<AnyInt>.fromList([2, 3, 4], [3], DType.int32);
    ...
    print('\n=== union1d ===');
    final un1 = NDArray<AnyInt>.fromList([1, 2, 3], [3], DType.int32);
    final un2 = NDArray<AnyInt>.fromList([2, 3, 4, 5], [4], DType.int32);
