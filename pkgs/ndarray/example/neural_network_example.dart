...
Dataset generateConcentricCircles(
  ...
  return NDArray.scope(() {
    ...
    final two = NDArray.fromList([2.0], [], DType.float64);
    final one = NDArray.fromList([1.0], [], DType.float64);
...
final class MLP {
  ...
  MLP({
    ...
    final twoLimit1 = NDArray.fromList([2.0 * limit1], [], DType.float64);
    final limit1Arr = NDArray.fromList([limit1], [], DType.float64);
    ...
    final twoLimit2 = NDArray.fromList([2.0 * limit2], [], DType.float64);
    final limit2Arr = NDArray.fromList([limit2], [], DType.float64);
    ...
    one = NDArray.fromList([1.0], [], DType.float64);
    zero = NDArray.fromList([0.0], [], DType.float64);
  }
  ...
  void update() {
    ...
    final lrScaled = NDArray.fromList([lrScaledVal], [], DType.float64);
...
double calculateAccuracy(NDArray<Float64> A2, NDArray<Float64> Y) {
  return NDArray.scope(() {
    final threshold = NDArray.fromList([0.5], [], DType.float64);
