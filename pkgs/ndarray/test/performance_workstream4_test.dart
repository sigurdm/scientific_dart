...
void main() {
  group('Workstream 4: Counting Sort for uint8', () {
    test(
      ...
      () {
        ...
        final a = NDArray<AnyInt>.fromList(data, [data.length], DType.uint8);
  ...
  group('Workstream 4: Level 2 BLAS GEMV', () {
    ...
    test('Vector (1D) x Matrix (2D) float64', () {
      // x: 2, B: 2x3 -> y: 3
      final x = NDArray<AnyFloat>.fromList([2.0, 3.0], [2], DType.float64);
    ...
    test('Matrix (2D) x Vector (1D) float32', () {
      ...
      final x = NDArray<AnyFloat>.fromList([3.0, 4.0], [2], DType.float32);
    ...
    test('Vector (1D) x Matrix (2D) float32', () {
      final x = NDArray<AnyFloat>.fromList([1.0, 2.0], [2], DType.float32);
      final b = NDArray<AnyFloat>.fromList(
        [3.0, 4.0, 5.0, 6.0],
        [2, 2],
        DType.float32,
    ...
    test('Transposed Matrix x Vector float64 (GEMV trans)', () {
      ...
      final x = NDArray<AnyFloat>.fromList([1.0, 2.0, 3.0], [3], DType.float64);
    ...
    test('Vector x Transposed Matrix float64 (GEMV trans)', () {
      final x = NDArray<AnyFloat>.fromList([1.0, 2.0], [2], DType.float64);
      final b = NDArray<AnyFloat>.fromList(
        [1.0, 4.0, 2.0, 5.0, 3.0, 6.0],
        [3, 2],
        DType.float64,
