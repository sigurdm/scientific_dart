...
void main() {
  group('NDArray Logical Reductions (all, any) Tests', () {
    test('all() basic global reduction checks', () => NDArray.scope(() {
    ...
    test('any() basic global reduction checks', () => NDArray.scope(() {
    ...
    test('all() axis reductions on 2D matrices', () => NDArray.scope(() {
    ...
    test('any() axis reductions on 2D matrices', () => NDArray.scope(() {
      final mat = NDArray.fromList(
    ...
    test('Axis out of bounds throws ArgumentError', () => NDArray.scope(() {
      final a = NDArray.fromList([true, false], [2], DType.boolean);
