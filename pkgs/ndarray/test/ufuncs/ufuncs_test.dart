  ...
  group('Vectorized Bitwise Operations Tests', () {
    ...
    test('named recycler out parameter buffer reuse', () {
      NDArray.scope(() {
        ...
        final out = NDArray<DTypeTag>.create([2], DType.int32);
    ...
    test('recycler out buffer shape incompatibility throws ArgumentError', () {
      NDArray.scope(() {
        final a = NDArray.fromList([5, 12], [2], DType.int32);
        final b = NDArray.fromList([3, 4], [2], DType.int32);
        final wrongOut = NDArray<DTypeTag>.create([3], DType.int32);
  ...
  group('Top-Level Comparison ufuncs with Recycling Tests', () {
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final b = NDArray<DTypeTag>.create([2], DType.complex128);
  ...
  group('NumPy Compatibility Universal Functions (ufuncs) tests', () {
    group('square ufunc', () {
      ...
      test('out recycler buffer', () {
        ...
        final outRecycler = NDArray<DTypeTag>.zeros([2], DType.float64);
    ...
    group('floating-point classifications (isnan, isinf, isfinite)', () {
      ...
      test('complex types', () {
        final a = NDArray<DTypeTag>.create([3], DType.complex128);
  ...
  group('Universal Functions (ufuncs) & Broadcasting Tests', () {
    ...
    group('New Math Ufuncs', () {
      test(
        ...
        () => NDArray.scope(() {
          ...
          final c = NDArray<DTypeTag>.create([1], DType.complex128);
          c[[0]] = Complex(0.0, 0.0);
          final resC = tan(c);
    ...
    group('Comparison Operator Broadcasting', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          final c1 = NDArray<DTypeTag>.create([1], DType.complex128);
          c1[[0]] = Complex(1, 2);

          final c2 = NDArray<DTypeTag>.create([1], DType.complex128);
          c2[[0]] = Complex(1, 2);
  ...
  group('NDArray Logical Reductions (all, any) Tests', () {
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        // Complex128 / boolean
        final c128 = NDArray<DTypeTag>.create([3], DType.complex128);
    ...
    test(
      ...
      () => NDArray.scope(() {
        final a = NDArray<DTypeTag>.ones([3], DType.float64);
        final b = NDArray<DTypeTag>.ones([3], DType.float64);
        final incompatibleOut = NDArray<DTypeTag>.ones([4], DType.float64);
        final incompatibleDTypeOut = NDArray<DTypeTag>.ones([3], DType.int32);
    ...
    test(
      ...
      () => NDArray.scope(() {
        final f64 = NDArray<DTypeTag>.fromList([1.0], [1], DType.float64);
        final f32 = NDArray<DTypeTag>.fromList([2.0], [1], DType.float32);
        final i64 = NDArray<DTypeTag>.fromList([3], [1], DType.int64);
        final i32 = NDArray<DTypeTag>.fromList([4], [1], DType.int32);
    ...
    test(
      ...
      () => NDArray.scope(() {
        final f64 = NDArray<DTypeTag>.fromList(
          [2.0, 3.0, 4.0],
          [3],
          DType.float64,
        );
        final f32 = NDArray<DTypeTag>.fromList(
          [5.0, 2.0, 3.0],
          [3],
          DType.float32,
        );
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final out = NDArray<DTypeTag>.zeros([2, 2], DType.float64);
        final incompatibleOut = NDArray<DTypeTag>.zeros([3], DType.float64);
    ...
    test(
      ...
      () {
        ...
        final a = NDArray<DTypeTag>.zeros([5], DType.float64);
        a.fill(42.5);
        expect(a.toList(), [42.5, 42.5, 42.5, 42.5, 42.5]);

        // 2. Contiguous Int32 Precision fill
        final b = NDArray<DTypeTag>.zeros([5], DType.int32);
        b.fill(99);
    ...
    test(
      ...
      () => NDArray.scope(() {
        final comp = NDArray<DTypeTag>.create([2], DType.complex128);
  ...
  group('Min/Max/NanMin/NanMax Branch Coverage', () {
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final outShape = NDArray<DTypeTag>.zeros([2], DType.float64);
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final parent = NDArray<DTypeTag>.zeros([2, 2], DType.float64);
