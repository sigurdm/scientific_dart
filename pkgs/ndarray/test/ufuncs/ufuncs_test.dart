  ...
  group('Vectorized Bitwise Operations Tests', () {
    ...
    test('named recycler out parameter buffer reuse', () {
      NDArray.scope(() {
        ...
        final out = NDArray<AnyInt>.create([2], DType.int32);
    ...
    test('recycler out buffer shape incompatibility throws ArgumentError', () {
      NDArray.scope(() {
        final a = NDArray.fromList([5, 12], [2], DType.int32);
        final b = NDArray.fromList([3, 4], [2], DType.int32);
        final wrongOut = NDArray<AnyInt>.create([3], DType.int32);
  ...
  group('Top-Level Comparison ufuncs with Recycling Tests', () {
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final b = NDArray<AnyComplex>.create([2], DType.complex128);
  ...
  group('NumPy Compatibility Universal Functions (ufuncs) tests', () {
    group('square ufunc', () {
      ...
      test('out recycler buffer', () {
        ...
        final outRecycler = NDArray<AnyFloat>.zeros([2], DType.float64);
    ...
    group('floating-point classifications (isnan, isinf, isfinite)', () {
      ...
      test('complex types', () {
        final a = NDArray<AnyComplex>.create([3], DType.complex128);
  ...
  group('Universal Functions (ufuncs) & Broadcasting Tests', () {
    ...
    group('New Math Ufuncs', () {
      test(
        ...
        () => NDArray.scope(() {
          ...
          final c = NDArray<AnyComplex>.create([1], DType.complex128);
          c[[0]] = Complex(0.0, 0.0);
          final resC = tan(c);
    ...
    group('Comparison Operator Broadcasting', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          final c1 = NDArray<AnyComplex>.create([1], DType.complex128);
          c1[[0]] = Complex(1, 2);

          final c2 = NDArray<AnyComplex>.create([1], DType.complex128);
          c2[[0]] = Complex(1, 2);
  ...
  group('NDArray Logical Reductions (all, any) Tests', () {
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        // Complex128 / boolean
        final c128 = NDArray<AnyComplex>.create([3], DType.complex128);
    ...
    test(
      ...
      () => NDArray.scope(() {
        final a = NDArray<AnyFloat>.ones([3], DType.float64);
        final b = NDArray<AnyFloat>.ones([3], DType.float64);
        final incompatibleOut = NDArray<AnyFloat>.ones([4], DType.float64);
        final incompatibleDTypeOut = NDArray<AnyInt>.ones([3], DType.int32);
    ...
    test(
      ...
      () => NDArray.scope(() {
        final f64 = NDArray<AnyFloat>.fromList([1.0], [1], DType.float64);
        final f32 = NDArray<AnyFloat>.fromList([2.0], [1], DType.float32);
        final i64 = NDArray<AnyInt>.fromList([3], [1], DType.int64);
        final i32 = NDArray<AnyInt>.fromList([4], [1], DType.int32);
    ...
    test(
      ...
      () => NDArray.scope(() {
        final f64 = NDArray<AnyFloat>.fromList(
          [2.0, 3.0, 4.0],
          [3],
          DType.float64,
        );
        final f32 = NDArray<AnyFloat>.fromList(
          [5.0, 2.0, 3.0],
          [3],
          DType.float32,
        );
    ...
    test(
      ...
      () {
        ...
        final out = NDArray<AnyFloat>.zeros([2, 2], DType.float64);
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final out = NDArray<AnyFloat>.zeros([2, 2], DType.float64);
        final incompatibleOut = NDArray<AnyFloat>.zeros([3], DType.float64);
    ...
    test(
      ...
      () {
        ...
        final a = NDArray<AnyFloat>.zeros([5], DType.float64);
        a.fill(42.5);
        expect(a.toList(), [42.5, 42.5, 42.5, 42.5, 42.5]);

        // 2. Contiguous Int32 Precision fill
        final b = NDArray<AnyInt>.zeros([5], DType.int32);
        b.fill(99);
    ...
    test(
      ...
      () => NDArray.scope(() {
        final comp = NDArray<AnyComplex>.create([2], DType.complex128);
  ...
  group('Min/Max/NanMin/NanMax Branch Coverage', () {
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final outShape = NDArray<AnyFloat>.zeros([2], DType.float64);
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final parent = NDArray<AnyFloat>.zeros([2, 2], DType.float64);
