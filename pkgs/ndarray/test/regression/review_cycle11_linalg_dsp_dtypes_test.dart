      ...
      group('dtype=${dtype.name}', () {
        ...
        test('cholesky promotes to float64 and decomposes SPD matrix', () {
          NDArray.scope(() {
            ...
            final l = cholesky(a);
            expect(l.dtype, equals(DType.float64));
        ...
        test('qr promotes to float64 and satisfies Q * R == A', () {
          NDArray.scope(() {
            ...
            expect(res.r.dtype, equals(DType.float64));
        ...
        test('svd promotes to float64 and computes singular values', () {
          NDArray.scope(() {
            ...
            final res = svd(a);
            expect(res.u.dtype, equals(DType.float64));
            expect(res.s.dtype, equals(DType.float64));
            expect(res.vh.dtype, equals(DType.float64));
