...
void main() {
  group('Bincount Tests', () {
    ...
    test('Basic contiguous unweighted (int32)', () {
      NDArray.scope(() {
        ...
        final out = NDArray<DTypeTag>.zeros([8], DType.int32);
    ...
    test('Empty input', () {
      NDArray.scope(() {
        final x = NDArray<DTypeTag>.zeros([0], DType.int64);
        final counts = bincount(x);
    ...
    test('Disposed arrays throw StateError', () {
      NDArray.scope(() {
        ...
        final out = NDArray<DTypeTag>.zeros([3], DType.int64);
        out.dispose();
    ...
    test('Validation errors extra', () {
      NDArray.scope(() {
        ...
        final outBadShape = NDArray<DTypeTag>.zeros([3, 1], DType.int64);
        expect(() => bincount(x, out: outBadShape), throwsArgumentError);

        final outBadSize = NDArray<DTypeTag>.zeros([2], DType.int64);
    ...
    test('Non-standard and mismatched dtypes', () {
      NDArray.scope(() {
        ...
        final outInt64 = NDArray<DTypeTag>.zeros([3], DType.int64);
        ...
        final outInt32 = NDArray<DTypeTag>.zeros([3], DType.int32);
        ...
        final outFloat64 = NDArray<DTypeTag>.zeros([3], DType.float64);
  ...
  group('Digitize Tests', () {
    ...
    test('Validation errors', () {
      NDArray.scope(() {
        ...
        final binsEmpty = NDArray<DTypeTag>.zeros([0], DType.float64);
  ...
  group('Histogram Tests', () {
    ...
    test('Empty input', () {
      NDArray.scope(() {
        final x = NDArray<DTypeTag>.zeros([0], DType.float64);
