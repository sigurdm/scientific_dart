    ...
    group('trapz composite trapezoidal integration', () {
      ...
      test('trapz error handling', () {
        NDArray.scope(() {
          ...
          final dispOut = NDArray<AnyFloat>.zeros([], DType.float64)..dispose();
          ...
          final badOutShape = NDArray<AnyFloat>.zeros([2], DType.float64);
    ...
    group('gradient and gradientArray', () {
      ...
      test('2D multi-axis gradient and gradientArray', () {
        NDArray.scope(() {
          ...
          final out0 = NDArray<AnyFloat>.zeros([3, 3], DType.float64);
          final out1 = NDArray<AnyFloat>.zeros([3, 3], DType.float64);
