...
void main() {
  final allDTypes = <DType<DTypeTag>>[
    DType.float64,
    DType.float32,
    DType.float16,
    DType.bfloat16,
  ...
  final numericDTypes = <DType<DTypeTag>>[
    DType.float64,
    DType.float32,
    DType.float16,
    DType.bfloat16,
  ...
  final integerDTypes = <DType<DTypeTag>>[
    DType.int64,
    DType.int32,
    DType.int16,
    DType.int8,
  ...
  group('Deep Coverage 90%+: Stats, Binning, NaN Metrics, Calculus & Padding', () {
    ...
    group('1. Histograms & Multi-dimensional Binning', () {
      group('bincount', () {
        test('empty input array handling', () {
          NDArray.scope(() {
            final empty = NDArray<DTypeTag>.fromList([], [0], DType.int64);
            ...
            final out = NDArray<DTypeTag>.fromList([9, 9, 9], [3], DType.int64);
          ...
          () {
            NDArray.scope(() {
              ...
              for (final dt in integerDTypes) {
                // Contiguous
                final arr = NDArray<DTypeTag>.fromList(data, [8], dt);
                ...
                // Out buffer
                final out = NDArray<DTypeTag>.zeros([5], dt);
                ...
                final stridedArr = NDArray<DTypeTag>.fromList(stridedData, [
                  15,
        ...
        test(
          ...
          () {
            NDArray.scope(() {
              ...
              final outU8 = NDArray<DTypeTag>.zeros([4], DType.uint8);
            ...
            NDArray.scope(() {
              ...
              for (final xDt in integerDTypes) {
                for (final wDt in [DType.float64, DType.float32]) {
                  final x = NDArray<DTypeTag>.fromList(xData, [6], xDt);
                  ...
                  // Strided
                  final xFull = NDArray<DTypeTag>.fromList(
        ...
        test('bincount validation and error branches', () {
          NDArray.scope(() {
            final xDisposed = NDArray<DTypeTag>.fromList(
              [1, 2],
              [2],
              DType.int32,
            )..dispose();
            ...
            final x2D = NDArray<DTypeTag>.fromList(
              [1, 2, 3, 4],
              [2, 2],
              DType.int32,
            );
            ...
            final xNegative = NDArray<DTypeTag>.fromList(
              [1, -2, 3],
              [3],
              DType.int32,
            );
            ...
            final xValid = NDArray<DTypeTag>.fromList(
              [1, 2, 3],
              [3],
              DType.int32,
            );
            ...
            final outDisposed = NDArray<DTypeTag>.zeros([4], DType.int64)
              ..dispose();
            expect(() => bincount(xValid, out: outDisposed), throwsStateError);

            final outTooSmall = NDArray<DTypeTag>.zeros([2], DType.int64);
            expect(
              () => bincount(xValid, out: outTooSmall),
              throwsArgumentError,
            );

            final outWrongRank = NDArray<DTypeTag>.zeros([2, 2], DType.int64);
            expect(
      ...
      group('digitize', () {
        ...
        test('digitize 2D input array and custom DType conversion', () {
          NDArray.scope(() {
            ...
            final binsInt = NDArray<DTypeTag>.fromList(
              [1, 3, 10],
              [3],
              DType.int64,
            );
        ...
        test('digitize error and validation branches', () {
          NDArray.scope(() {
            ...
            final complexX = NDArray<DTypeTag>.fromList(
              [Complex(1, 0)],
              [1],
              DType.complex128,
            );
            ...
            final outDisposed = NDArray<DTypeTag>.zeros([2], DType.int32)
              ..dispose();
            expect(() => digitize(x, bins, out: outDisposed), throwsStateError);

            final outBadShape = NDArray<DTypeTag>.zeros([3], DType.int32);
            expect(
      ...
      group('histogram', () {
        ...
        test(
          ...
          () {
            NDArray.scope(() {
              ...
              // Int edges
              final intEdges = NDArray<DTypeTag>.fromList(
                [0, 2, 5],
                [3],
                DType.int32,
              );
        ...
        test('histogram validation and error branches', () {
          NDArray.scope(() {
            ...
            final complexData = NDArray<DTypeTag>.fromList(
              [Complex(1, 0)],
              [1],
              DType.complex128,
            );
    ...
    group('2. Complete Suite of Reductions & Statistics', () {
      test('sum across all 15 DTypes with contiguous and strided slices', () {
        NDArray.scope(() {
          for (final dt in allDTypes) {
            final NDArray<DTypeTag> arr = dt.isComplex
                ? NDArray<DTypeTag>.fromList(
      ...
      test('prod across all 15 DTypes with empty arrays and axes', () {
        NDArray.scope(() {
          for (final dt in allDTypes) {
            final NDArray<DTypeTag> empty = dt.isComplex
                ? NDArray<DTypeTag>.fromList([], [0], dt)
                : dt == DType.boolean
        ...
        () {
          NDArray.scope(() {
            for (final dt in allDTypes) {
              ...
              final NDArray<DTypeTag> arr2D = dt.isComplex
                  ? NDArray<DTypeTag>.fromList(
                      [
                        Complex(1, 1),
                        Complex(2, 2),
      ...
      test('cumsum, cumprod, cummin, cummax across axes and DTypes', () {
        NDArray.scope(() {
          ...
          final cp = cumprod(
            NDArray<DTypeTag>.fromList([1, 2, 3, 4], [4], DType.int32),
          );
          expect(cp.toList(), equals([1, 2, 6, 24]));

          final cmin = cummin(
            NDArray<DTypeTag>.fromList([5, 2, 8, 1, 9], [5], DType.int32),
          );
      ...
      test(
        ...
        () {
          NDArray.scope(() {
            ...
            final fw = NDArray<DTypeTag>.fromList([1, 2, 1], [3], DType.int32);
    ...
    group('4. Calculus & Numerical Differentiation / Integration', () {
      group('trapz', () {
        test(
          ...
          () {
            NDArray.scope(() {
              ...
              final yC64 = NDArray<DTypeTag>.fromList(
              ...
              final yC128 = NDArray<DTypeTag>.fromList(
                [Complex(1, 1), Complex(2, 2), Complex(4, 4)],
                [3],
                DType.complex128,
              );
        ...
        test('trapz validation errors', () {
          NDArray.scope(() {
            final yInt = NDArray<DTypeTag>.fromList(
              [1, 2, 3],
              [3],
              DType.int32,
            );
        ...
        test(
          ...
          () {
            NDArray.scope(() {
              ...
              final fC64 = NDArray<DTypeTag>.fromList(
              ...
              final fC128 = NDArray<DTypeTag>.fromList(
                [Complex(0, 0), Complex(1, 1), Complex(4, 4)],
                [3],
                DType.complex128,
              );
    ...
    group('5. Padding Deep Coverage Across All 15 DTypes & Modes', () {
      ...
      test(
        ...
        () {
          NDArray.scope(() {
            final a3D = NDArray<DTypeTag>.fromList(
            ...
            final out = NDArray<DTypeTag>.zeros([3, 6, 7], DType.int32);
    ...
    group('6. Stats Error Paths & Out Buffers Deep Coverage', () {
      ...
      test('min, max, ptp error paths and empty array checks', () {
        NDArray.scope(() {
          final empty = NDArray<DTypeTag>.fromList([], [0], DType.int32);
          ...
          final aDisp = NDArray<DTypeTag>.fromList([1], [1], DType.int32)
            ..dispose();
          expect(() => min(aDisp), throwsStateError);
          expect(() => max(aDisp), throwsStateError);
          expect(() => ptp(aDisp), throwsStateError);

          final outDisp = NDArray<DTypeTag>.zeros([2], DType.int32)..dispose();
          ...
          final outBad = NDArray<DTypeTag>.zeros([5], DType.int32);
          ...
          final outGlobalInt = NDArray<DTypeTag>.zeros([], DType.int32);
      ...
      test('cumsum, cumprod, cummin, cummax error paths and out buffers', () {
        NDArray.scope(() {
          ...
          final outDisp = NDArray<DTypeTag>.zeros([2, 2], DType.int32)
            ..dispose();
          ...
          final out2D = NDArray<DTypeTag>.zeros([2, 2], DType.int32);
      ...
      test(
        ...
        () {
          NDArray.scope(() {
            ...
            final intArr = NDArray<DTypeTag>.fromList(
              [1, 2, 3, 4],
              [2, 2],
              DType.int32,
            );
      ...
      test(
        ...
        () {
          NDArray.scope(() {
            ...
            final a = NDArray<Float64>.fromList([1.0, 2.0], [2], DType.float64);
            final outBadDType = NDArray<DTypeTag>.zeros([4], DType.int32);
            expect(
    ...
    group('8. Full DType Sweep of Strided Reductions, Quantiles & Covariances', () {
      ...
      test('empty array reductions across all DTypes', () {
        NDArray.scope(() {
          ...
          final emptyCpx = NDArray<DTypeTag>.fromList([], [
            0,
          ], DType.complex128);
          ...
          // Int sum on empty
          final emptyInt = NDArray<DTypeTag>.fromList([], [0], DType.int32);
      ...
      test(
        ...
        () {
          NDArray.scope(() {
            ...
            final fweightsDisp = NDArray<DTypeTag>.fromList(
              [1, 2],
              [2],
              DType.int32,
            )..dispose();
            ...
            final emptyArr = NDArray<DTypeTag>.fromList([], [0], DType.int32);
            expect(() => cov(emptyArr), throwsArgumentError);
            expect(() => cov(intArr, y: emptyArr), throwsArgumentError);

            final arr3D = NDArray<DTypeTag>.fromList(
              List.generate(8, (i) => i),
              [2, 2, 2],
              DType.int32,
            );
    ...
    group('9. Remaining Strided FFI Kernels, Complex & Boolean Reductions', () {
      test(
        ...
        () {
          NDArray.scope(() {
            // Complex128 strided
            final c128Full = NDArray<DTypeTag>.fromList(
              [
                Complex(1, 1),
                Complex(99, 99),
                Complex(2, 2),
            ...
            // Complex64 strided
            final c64Full = NDArray<DTypeTag>.fromList(
            ...
            final u8Full = NDArray<DTypeTag>.fromList(
              [2, 99, 4, 99, 6],
              [5],
              DType.uint8,
            );
            ...
            final u8_2D = NDArray<DTypeTag>.fromList(
              [1, 2, 3, 4],
              [2, 2],
              DType.uint8,
            );
      ...
      test('nanmin, nanmax complex exception and uint8 support', () {
        NDArray.scope(() {
          ...
          final u8Arr = NDArray<DTypeTag>.fromList(
            [10, 20, 5],
            [3],
            DType.uint8,
          );
      ...
      test('cov with 2D y array and fweights size validation', () {
        NDArray.scope(() {
          ...
          final fweightsBad = NDArray<DTypeTag>.fromList(
            [1, 2],
            [2],
            DType.int32,
          );
      ...
      test('strided quantile across multiple dtypes', () {
        NDArray.scope(() {
          ...
          final i32Full = NDArray<DTypeTag>.fromList(
            [10, 99, 20, 99, 30],
            [5],
            DType.int32,
          );
    ...
    group('10. Ultimate Coverage Sweep', () {
      test(
        ...
        () {
          NDArray.scope(() {
            for (final dt in allDTypes) {
              final NDArray<DTypeTag> arrFull;
              if (dt.isComplex) {
                arrFull = NDArray<DTypeTag>.fromList(
                  [
                    Complex(1, 1),
                    Complex(99, 99),
                    Complex(2, 2),
      ...
      test('cov advanced weights validation and 2D y shape adjustments', () {
        NDArray.scope(() {
          ...
          // Negative fweights
          final negFw = NDArray<DTypeTag>.fromList(
            [1, -1, 1],
            [3],
            DType.int32,
          );
      ...
      test('nanmean on complex 2D array along axes', () {
        NDArray.scope(() {
          final cpx2D = NDArray<DTypeTag>.fromList(
            [
              Complex(1.0, 2.0),
    ...
    group('11. Full Axis Reductions Across All DTypes', () {
      ...
      test('mean, std, variance, nanmin, nanmax on uint8 2D along axes', () {
        NDArray.scope(() {
          final u8 = NDArray<DTypeTag>.fromList(
            [10, 20, 30, 40],
            [2, 2],
            DType.uint8,
          );
