...
void main() {
  final allDTypes = <DType<AnyDType>>[
    DType.float64,
    DType.float32,
    DType.float16,
    DType.bfloat16,
  ...
  final numericDTypes = <DType<AnyReal>>[
    DType.float64,
    DType.float32,
    DType.float16,
    DType.bfloat16,
  ...
  final integerDTypes = <DType<AnyInt>>[
    DType.int64,
    DType.int32,
    DType.int16,
    DType.int8,
  ...
  group('Deep Coverage 90%+: Stats, Binning, NaN Metrics, Calculus & Padding', () {
      ...
      group('bincount', () {
        ...
        test('bincount validation and error branches', () {
          NDArray.scope(() {
            ...
            final xValid = NDArray<AnyInt>.fromList(
              [1, 2, 3],
              [3],
              DType.int32,
            );
            ...
            final outDisposed = NDArray<AnyInt>.zeros([4], DType.int64)
              ..dispose();
      ...
      group('digitize', () {
        ...
        test('digitize 2D input array and custom DType conversion', () {
          NDArray.scope(() {
            ...
            final binsInt = NDArray<AnyInt>.fromList(
              [1, 3, 10],
              [3],
              DType.int64,
            );
        ...
        test('digitize error and validation branches', () {
          NDArray.scope(() {
            ...
            final outDisposed = NDArray<AnyInt>.zeros([2], DType.int32)
              ..dispose();
        ...
        NDArray.scope(() {
          for (final dt in allDTypes) {
            final NDArray<AnyDType> empty = dt.isComplex
                ? NDArray<AnyComplex>.fromList([], [0], dt as DType<AnyComplex>)
                : dt == DType.boolean
      ...
      test(
        ...
        () {
          NDArray.scope(() {
            ...
            final cpxMean = nanmean<AnyComplex>(cpx);
    ...
    group('5. Padding Deep Coverage Across All 15 DTypes & Modes', () {
      test(
        ...
        () {
          ...
          final pv = PadValues<AnyFloat>.all(1.0, 2.0);
    ...
    group('6. Stats Error Paths & Out Buffers Deep Coverage', () {
      ...
      test('min, max, ptp error paths and empty array checks', () {
        NDArray.scope(() {
          ...
          final aDisp = NDArray<AnyInt>.fromList([1], [1], DType.int32)
            ..dispose();
    ...
    group('7. Padding & Calculus Advanced Corner Cases', () {
      test('PadValues and StatLength constructors and edge validations', () {
        final pvAxes = PadValues<AnyFloat>.axes([(1.0, 2.0), (3.0, 4.0)]);
    ...
    group('8. Full DType Sweep of Strided Reductions, Quantiles & Covariances', () {
      ...
      test('empty array reductions across all DTypes', () {
        NDArray.scope(() {
          ...
          final emptyCpx = NDArray<AnyComplex>.fromList([], [
            0,
          ], DType.complex128);
      ...
      test(
        ...
        () {
          NDArray.scope(() {
            ...
            final fweightsDisp = NDArray<AnyInt>.fromList(
              [1, 2],
              [2],
              DType.int32,
            )..dispose();
    ...
    group('9. Remaining Strided FFI Kernels, Complex & Boolean Reductions', () {
      ...
      test('cov with 2D y array and fweights size validation', () {
        NDArray.scope(() {
          ...
          final fweightsBad = NDArray<AnyInt>.fromList(
            [1, 2],
            [2],
            DType.int32,
          );
    ...
    group('10. Ultimate Coverage Sweep', () {
      ...
      test('nanmean on complex 2D array along axes', () {
        NDArray.scope(() {
          ...
          final nmAx0 = nanmean<AnyComplex>(cpx2D, axis: 0);
          expect(nmAx0.shape, [2]);

          final nmAx1 = nanmean<AnyComplex>(cpx2D, axis: 1);
