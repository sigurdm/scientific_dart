  ...
  group('NDArray Sorting, Searching & Counting Tests', () {
    ...
    group('argsort (Indirect index sorting) tests', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          final scalar = NDArray.scalar(99.0, dtype: DType.float64);
    ...
    group('where (Ternary Select & SIMD) tests', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          ...
          final res = where(cond) as List<NDArray<DTypeTag>>;
          expect(res.length, 1);
      ...
      group('Argmin/Argmax Branch Coverage', () {
        ...
        test(
          ...
          () => NDArray.scope(() {
            ...
            final outFlat = NDArray<DTypeTag>.zeros([], DType.int32);
            final resFlat = argmin(a, out: outFlat);
            expect(identical(resFlat, outFlat), true);
            expect(outFlat.scalar, 2);

            final outAxis = NDArray<DTypeTag>.zeros([1], DType.int32);
            final mat = NDArray.fromList(
              [10.0, 50.0, 5.0],
              [1, 3],
              DType.float64,
        ...
        test(
          ...
          () => NDArray.scope(() {
            final a = NDArray.fromList([1.0, 2.0], [2], DType.float64);
            final out = NDArray<DTypeTag>.zeros([], DType.int32);
            out.dispose();
        ...
        test(
          ...
          () => NDArray.scope(() {
            ...
            // Incompatible shape
            final outShape = NDArray<DTypeTag>.zeros([2], DType.int32);
            expect(() => argmin(a, out: outShape), throwsArgumentError);
            expect(() => argmax(a, out: outShape), throwsArgumentError);

            // Incompatible dtype
            final outDType = NDArray<DTypeTag>.zeros([], DType.float64);
            expect(
    ...
    group('searchsorted tests', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          final aComp = NDArray<DTypeTag>.fromList(
            [Complex(1.0, 1.0), Complex(2.0, 2.0), Complex(3.0, 3.0)],
            [3],
            DType.complex128,
          );

          final vComp = NDArray<DTypeTag>.fromList(
    ...
    group('findIndex tests', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          ...
          final empty = NDArray<DTypeTag>.create([0], DType.float64);
    ...
    group('argwhere Tests', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          final nonzeroScalar = NDArray.scalar(5.0, dtype: DType.float64);
          final res1 = argwhere(nonzeroScalar);
          expect(res1.shape, [1, 0]);
          expect(res1.toList(), <int>[]);

          final zeroScalar = NDArray.scalar(0.0, dtype: DType.float64);
    ...
    group('partition & argpartition Expansion', () {
      test(
        ...
        () => NDArray.scope(() {
          ...
          final c64 = NDArray<DTypeTag>.fromList(
            [
              Complex(3.0, 3.0),
              Complex(1.0, 1.0),
              Complex(4.0, 4.0),
    ...
    group('where Expansion', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          ...
          final x9 = NDArray<DTypeTag>.zeros([
            1,
            1,
            1,
            1,
          ...
          final y9 = NDArray<DTypeTag>.zeros([
            1,
            1,
            1,
            1,
          ...
          final outBadShape = NDArray<DTypeTag>.zeros([3], DType.float64);
          expect(() => where(cond, x, y, outBadShape), throwsArgumentError);

          final outBadDType = NDArray<DTypeTag>.zeros([2], DType.int32);
          expect(
    ...
    group('Workstream 4: Sorting & Searching Enhancements', () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          ...
          final outLeft = NDArray<DTypeTag>.zeros([2], DType.int64);
          ...
          final outRight = NDArray<DTypeTag>.zeros([2], DType.int64);
