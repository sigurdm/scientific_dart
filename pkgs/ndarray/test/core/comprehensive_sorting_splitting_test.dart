  ...
  group('Comprehensive Sorting & Argsort Tests', () {
    test(
      ...
      () => NDArray.scope(() {
        ...
        for (final dtype in [DType.complex128, DType.complex64]) {
          final arr = NDArray<AnyComplex>.fromList(
            [
              Complex(3.0, 1.0),
              Complex(1.0, 5.0),
              Complex(2.0, -1.0),
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final outArgsortScalar = NDArray<AnyInt>.create(<int>[], DType.int32);
        ...
        final outSort = NDArray<AnyInt>.create([3], DType.int32);
        final resSort = sort(a, out: outSort);
        expect(identical(resSort, outSort), true);
        expect(outSort.toList(), [1, 2, 3]);

        final outArgsort64 = NDArray<AnyInt>.create([3], DType.int64);
        ...
        final badOutShape = NDArray<AnyInt>.create([2], DType.int32);
  ...
  group('Comprehensive Partition & Argpartition Tests', () {
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final out64 = NDArray<AnyInt>.create([5], DType.int64);
  ...
  group('Comprehensive Searchsorted Tests', () {
    test(
      ...
      () => NDArray.scope(() {
        ...
        for (final dtype in [DType.complex128, DType.complex64]) {
          ...
          final v = NDArray<AnyComplex>.fromList(
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final out64 = NDArray<AnyInt>.create([2, 2], DType.int64);
  ...
  group('Comprehensive Nonzero, Argwhere & Count Nonzero Tests', () {
    ...
    test(
      ...
      () => NDArray.scope(() {
        ...
        final out = NDArray<AnyInt>.create([3], DType.int32);
  ...
  group('Comprehensive Splitting Tests', () {
    test(
      ...
      () => NDArray.scope(() {
        ...
        final out1 = NDArray<AnyInt>.create([3, 2], DType.int32);
        final out2 = NDArray<AnyInt>.create([3, 2], DType.int32);
