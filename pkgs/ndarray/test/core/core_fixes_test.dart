    ...
    group("6. operator [] coordinate vs row selection ergonomics", () {
      test(
        ...
        () => NDArray.scope(() {
          ...
          final res = a[[1, 3]] as NDArray<AnyInt>;
          expect(res.shape, [2]);
          expect(res.toList(), [20, 40]);

          final res3 = a[[0, 2, 4]] as NDArray<AnyInt>;
          expect(res3.shape, [3]);
      ...
      test(
        ...
        () => NDArray.scope(() {
          ...
          final row1 = a[1] as NDArray<AnyInt>;
          expect(row1.shape, [4]);
      ...
      test(
        ...
        () => NDArray.scope(() {
          ...
          final sub2D = a[0] as NDArray<AnyInt>;
    ...
    group("Stream 1 Core and Native fixes", () {
      ...
      test(
        ...
        () => NDArray.scope(() {
          ...
          final dest = NDArray<AnyInt>.zeros([4, 3], DType.int16);
