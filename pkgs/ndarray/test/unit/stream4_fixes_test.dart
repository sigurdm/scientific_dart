    ...
    test(
      ...
      () {
        NDArray.scope(() {
          ...
          final outArgSort = NDArray<AnyInt>.zeros([2, 3], DType.int32);
          ...
          final outArgPart = NDArray<AnyInt>.zeros([2, 3], DType.int32);
          ...
          final outScalarIdx = NDArray<AnyInt>.zeros([], DType.int32);
