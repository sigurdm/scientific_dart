    ...
    test(
      ...
      () {
        NDArray.scope(() {
          ...
          final outArgSort = NDArray<DTypeTag>.zeros([2, 3], DType.int32);
          ...
          final outArgPart = NDArray<DTypeTag>.zeros([2, 3], DType.int32);
          ...
          final outScalarIdx = NDArray<DTypeTag>.zeros([], DType.int32);
