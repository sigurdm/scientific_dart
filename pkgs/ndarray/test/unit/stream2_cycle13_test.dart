    ...
    test(
      ...
      () {
        NDArray.scope(() {
          ...
          final aIntPow = NDArray<DTypeTag>.fromList(
            [2, 3, 4],
            [3],
            DType.int32,
          );
          final bPow = NDArray<DTypeTag>.fromList([3, 2, 1], [3], DType.int32);
