...
void main() {
  group('NDArray Operator Overloading Tests', () {
    test('Basic Arithmetic Operators', () => NDArray.scope(() {
      final a = NDArray.fromList([1.0, 2.0, 3.0, 4.0], [2, 2], DType.float64);
      final b = NDArray.fromList([10.0, 20.0, 30.0, 40.0], [2, 2], DType.float64);
    ...
    test('Scalar Broadcasting Operators', () => NDArray.scope(() {
    ...
    test('Unary Negation', () => NDArray.scope(() {
      final a = NDArray.fromList([1.0, -2.0, 0.0], [3], DType.float64);
      final b = -a;
      expect(b.toList(), [-1.0, 2.0, 0.0]);
    }));

    test('Integer Division and Remainder', () => NDArray.scope(() {
    ...
    test('Bitwise Operators', () => NDArray.scope(() {
    ...
    test('Complex Arithmetic', () => NDArray.scope(() {
      final a = NDArray.fromList([Complex(1, 2), Complex(3, 4)], [2], DType.complex128);
      final b = NDArray.fromList([Complex(10, 20), Complex(30, 40)], [2], DType.complex128);
    ...
    test('Mixed Type Arithmetic', () => NDArray.scope(() {
