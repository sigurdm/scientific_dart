...
void _evaluateUniform(String label, NDArray<AnyFloat> arr) {
...
void _evaluateNormal(String label, NDArray<AnyFloat> arr) {
  final len = arr.data.length;
  final data = arr.data;
...
void _evaluateRandint(String label, NDArray<AnyInt> arr) {
  final len = arr.data.length;
  final data = arr.data;
