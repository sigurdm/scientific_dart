...
5. Optimization: Find a slow benchmark (always write a numpy equivalent) and try to catch up. Or if you have any other ideas how to improve the performance, try it out. First write a benchmark to show the performance difference, fix it, then write a benchmark to show the improvement. Consider using a profiler to find bottlenecks if they are not obvious. Append a note in DONE.md about what was done, how hard it was, and if there were any notable problems.
